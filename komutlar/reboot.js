...
module.exports.run = async (bot, message, args) => { 
  ...
  var embed2 = new Discord.RichEmbed()   
      ...
      .setDescription('sadece sahibim bu komutu  kullanabilir! Yani Pudochu `R#0001 ')
      .setColor('RED') 
  

  if(message.author.id !== "450006793884663820") return message.channel.sendEmbed(embed2)
