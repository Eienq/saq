...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:pirate:749380925619437619> **Bu komutu kullanabilmek için** "\`Yönetici\`" **yetkisine sahip olmalısın.**`);
 ...
 if(!rol) return message.reply(`<a:pirate:749380925619437619>  **Ayarlanmamış bir özellik sıfırlanamaz! :wink: **`)
 
 
  message.channel.send(`<a:pirate:749380925619437619>  **Otorol mesajı başarılı bir şekilde sıfırlandı.**`)
