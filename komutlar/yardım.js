...
"**Alone Music kullanıcılarının gizliliği;**\n\n<:guvenlik:735597569597767840>  Biz Alone Music geliştiricileri olarak sizin gizliliğinizi önemsiyor ve saygı duyuyoruz. Bu sebepten ötürü internet sayfamızda **Gizlilik** adlı bir konu açtık.\n\n**`Detaylı Bilgi:`**\n<a:secenek:733987076718198864> https://fynxmusic.tk/gizlilik",          
...
'**Alone Music Linkler**\n\n**• [Alone Music`i Ekleyin.](https://discord.com/oauth2/authorize?client_id=522870338867167254&scope=bot&permissions=8)**\n\n**• [Alone Music Websitesi](https://alonemusic.tk/)**\n\n**• [Yapımcı İnstagram Hesabı](https://instagram.com/m_arda_dusova)**'
];
let page = 1; 
