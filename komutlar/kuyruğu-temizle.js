...
.setColor(AloneDogru)
.setTitle("Alone Music - Kuyruğu Temizle")
...
.setTitle("• Hata: 011 •")
.setThumbnail(message.author.avatarURL())
.setDescription(`<a:yanlis:734892943332212764>  | Müzik Kuyruğunu temizleyebilmek için bir ses kanalında olmanız gerekmektedir!`)
.setFooter(`Alone Music © 2020 - All right reserved.`, client.user.avatarURL());  
