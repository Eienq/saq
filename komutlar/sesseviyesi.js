...
if (!sesseviyesi) return message.channel.send({embed: {color: AloneHata, description: `<a:yanlis:734892943332212764>  | Ses seviyesini ayarlayabilmek için sadece pozitif bir doğal sayı giriniz.` }})
